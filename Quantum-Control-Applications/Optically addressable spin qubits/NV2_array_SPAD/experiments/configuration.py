...
# channel for laser is AOM2, channel for SPAD trigger is digital output 5
...
detection_delay_2 = (1440 + 32 - 40) * u.ns  # 2026-03-03: account for 40 ns delay for SPAD gate
...
SPAD_delay = SPAD_HIT - initialization_len_2  # 20.8 us min repetition time - 3 us laser pulse
# SPAD_delay = 28200 * u.ns #31.2 us min repetition time - 3 us laser pulse #min HIT for GUI is 20.8 us, plus 10.4 us buffer
# for CW ODMR can use shorter SPAD delay since readout time longer
