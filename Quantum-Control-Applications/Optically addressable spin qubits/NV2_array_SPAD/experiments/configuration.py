...
x180_amp_NV = 0.18  # in units of volts #calibrate with #2026-02-10\#108_power_rabi_175847
...
#did not add extra detection delay relative to start of laser, according to one-note NV ensemble calibration 20260210
#0.48 mW optimal start time is 519 ns and duration of 384 ns (average of 372 and 396 from 2 methods)
