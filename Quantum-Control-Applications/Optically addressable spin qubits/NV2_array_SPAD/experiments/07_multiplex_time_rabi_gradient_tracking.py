...
t_vec = np.arange(4, 1000, 30)  # Pulse durations in clock cycles (4ns) #0.5 MHz Rabi
#t_vec = np.arange(4, 500, 10)  # Pulse durations in clock cycles (4ns) #0.5 MHz Rabi
...
n_avg = 750_000  # number of averages
    ...
    with program() as pulsed_odmr:
        ...
        with for_(n, 0, n < n_avg, n + 1):
            with for_(*from_array(t, t_vec)):
                ...
                # Play the mw pulse...
                play("x180" * amp(1), "NV0", duration=t)
                #play("x180" * amp(1), "NV1", duration=t)
                play("x180" * amp(1), "NV2", duration=t)
                align()
                wait(wait_after_gradient * u.ns)
